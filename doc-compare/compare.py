...
from helpers import lines, sentences, substrings, similarity
...
def main():
    ...
    group.add_argument("--similarity", action="store_true", help="show difference")
    ...
    if args["lines"]:
        ...
        matches = similarity(file1, file2)
